# -*- encoding: utf-8 -*-
# stub: redis-actionpack 5.0.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<redis-rack>, ["~> 2.0.0.pre"])
      s.add_runtime_dependency(%q<actionpack>, ["< 6", ">= 4.0.0"])
      ...
      s.add_dependency(%q<redis-rack>, ["~> 2.0.0.pre"])
      s.add_dependency(%q<actionpack>, ["< 6", ">= 4.0.0"])
